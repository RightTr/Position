...
void ReadParameters(ros::NodeHandle &nh)
{
    ...
    nh.param<float>("data_process/delta_dis_threshold", delta_dis_threshold, 0.5);
    nh.param<float>("data_process/delta_angle_threshold", delta_angle_threshold, 2);
}